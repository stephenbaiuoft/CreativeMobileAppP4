...
public class Person extends RealmObject {
    ...
    private com.example.stephenbai.assignment4.Dog dog;

    // One-to-many relations is simply a RealmList of the objects which also subclass RealmObject
    private RealmList<com.example.stephenbai.assignment4.Cat> cats;
    ...
    public com.example.stephenbai.assignment4.Dog getDog() {
        return dog;
    }

    public void setDog(com.example.stephenbai.assignment4.Dog dog) {
        this.dog = dog;
    }

    public RealmList<com.example.stephenbai.assignment4.Cat> getCats() {
        return cats;
    }

    public void setCats(RealmList<com.example.stephenbai.assignment4.Cat> cats) {
        this.cats = cats;
    }
